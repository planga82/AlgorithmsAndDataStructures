...
public class ArrayMaxBinaryHeapObjects {
    int capacity;
    Comparable arr[];
    int size = 0;

    public ArrayMaxBinaryHeapObjects(int capacity){
        this.capacity = capacity + 1;
        arr = new Comparable[this.capacity];
    }
    ...
    public void replaceRoot(Comparable k){
        arr[0] = k;
        reorderDown(0);
    }
