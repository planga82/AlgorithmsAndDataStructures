...
public class RobotPath {
    ...
    private static boolean isInstruction(char x){
        return x == 'N' || x == 'S' || x == 'W' || x == 'E';
    }
    private static boolean isRepetitive(char x){
        return !isInstruction(x) && x != '(' && x != ')';
    }
