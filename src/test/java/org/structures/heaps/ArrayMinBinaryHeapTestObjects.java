...
public class ArrayMinBinaryHeapTestObjects
{
    @Test
    public void test1(){
        Integer[] arr = {5, 9, 8, 3, 6, 1, 2, 3, 4, 5, 5, 3, 2, 2};
        ArrayMinBinaryHeapObjects heap = new ArrayMinBinaryHeapObjects(30);
    ...
    private void testStructure(ArrayMinBinaryHeapObjects heap){
        int size = heap.size;
